...
export default new Vuex.Store({
  ...
  getters: {
    home: (state) => (id) => {
      return state.home.find(home => home.id === id)
    }
  },
  actions: {
    GET_WEATHER({commit}){
